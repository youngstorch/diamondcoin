...
static const int64 nTargetTimespan = 5 * 24 * 60 * 60; // FooCoin: 1 days
static const int64 nTargetSpacing = 120; // FooCoin: 2 minute blocks
static const int64 nInterval = nTargetTimespan / nTargetSpacing;

// Thanks: Elia Minja for suggesting the following fix
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Created By Elia Minja";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1492900907; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1492900907;
            block.nNonce   = 0;
        }
